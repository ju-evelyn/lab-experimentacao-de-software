...
moda_linguagem_primaria = csv["Primary Language Number"].median()
...
print("Mediana das linguagens primárias:", moda_linguagem_primaria)
...
colunas = ['Repository Age', 'Accepted Pull Requests', 'Total Releases',
           'Time since last update', 'Primary Language Number', 'Closed Issues %']
